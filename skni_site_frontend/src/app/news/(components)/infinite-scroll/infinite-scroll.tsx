...
// Tutaj chat mi genereowal przykłady
const sampleNews: News[] = [
  {
    id: 1,
    title: "Nowa technologia AI rewolucjonizuje przemysł",
    description:
      "Naukowcy opracowali nowy algorytm sztucznej inteligencji, który zwiększa efektywność produkcji.",
    imageUrl:
  ...
  {
    id: 6,
    title: "Nowa aplikacja podbija rynek2",
    description:
      "Startup technologiczny zaprezentował aplikację, która ułatwia organizację codziennych obowiązków.",
    imageUrl: "https://kod.prz.edu.pl/img/placeholder.a8751ab8.png",
  },
  {
    id: 7,
    title: "Nowa aplikacja podbija rynek3",
    description:
      "Startup technologiczny zaprezentował aplikację, która ułatwia organizację codziennych obowiązków.",
    imageUrl: "https://kod.prz.edu.pl/img/placeholder.a8751ab8.png",
  },
...
const InfiniteScroll = () => {
  ...
  useEffect(() => {
    ...
    const newNews = sampleNews.slice(0, end);
