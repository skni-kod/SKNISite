...
const projects = [
    {
        title: "Kodemy",
        description: "Kodemy to aplikacja webowa umożliwiająca członkom koła dzielenie się z innymi godnymi uwagi materiałami do nauki różnych technologii związanych z IT.",
    ...
    {
        title: "PVAnalyzer",
        description: "To aplikacja webowa, która pozwala na analizę zużycia energii elektrycznej oraz oszczędności wynikających z instalacji paneli fotowoltaicznych.",
        category: "Sekcja Aplikacji Desktopowych Mobilnych i Webowych",
        id: 31
    },
    {
        title: "SKNI Tool",
        description: "SKNITool to projekt opracowany w trakcie NASA Space Apps Challange 2022 przez zespół \"SKNI KOD\" który tworzyli członkowie naszego koła: Oskar Tyniec Mateusz Fesz Arkadiusz Albiniak Jakub Przystasz Zespół przygotował prototyp narzędzia wielofunkcyjnego dla astronautów wysłanych na podbój czerwonej planety. Jury z NASA doceniło nasz projekt przyznając wyróżnienie spośród ponad 5 tys. drużyn - więcej o tym możecie przeczytać na stronie konkursu: Global Finalists Honorable Mentions W podkarpackiej edycji, nasz pomysł zdobył I miejsce.",
            ...
            <div className="flex flex-col gap-y-4 md:flex-row md:gap-x-4 w-full">
                <div className="grid grid-cols-1 w-full gap-y-4">
                    <div className="row-span-1">
                        ...
                        <Text variant="h2">
                            {t("landing-page.our-projects.subtitle")}
                        </Text>
                    </div>
                 ...
                 <div className="grid grid-cols-1 w-full">
                     ...
                     <div className="flex flex-col justify-center md:flex-row md:items-center md:gap-x-8 w-full sm:mt-8 md:mt-0">
                         ...
                         <div className="flex justify-between">
                             <Button variant="default" className="rounded-full py-6 px-6 w-full">
